...
function initHighcharts ()
{
    ...
    $('#graph1').highcharts({
        ...
        series: [{
            ...
            color: '#ff702a',
            name: '실적 효율',
            data: [600, 605, 610, 650, 610, 610, 680, 600, 615, 610, 605, 690, 650, 600]
		 }]
    });
}
...
function addGroupHeader() {
    ...
    $("#gridList").jqGrid('setGroupHeaders', {
        ...
        groupHeaders:[
			{startColumnName: 'goal', numberOfColumns: 2, titleText: '충방전 전력량 (kWh)'},
			{startColumnName: 'goal2', numberOfColumns: 2, titleText: '충방전 효율 (%)'}
        ]
    });
}
...
function jqGridBasic() {
    $('#gridList').jqGrid({
        ...
        colNames : [ "No", "일", "충전량", "방전량", "목표", "전년", "GAP (%)"],
