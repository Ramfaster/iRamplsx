...
function alarmList ()
{
    ...
    $ ( '#btn_alarmList' ).click (
            function ()
            {
                ...
                var preReleaseType = $ ( '#preReleaseType' ).val ();

                location.href = contextPath + '/hom/operation/alarm/list.do?searchDateType=' + preSearchDateType
                        ...
                        + encodeURI ( encodeURIComponent ( preSearchValue ) + "&releaseType=" + preReleaseType );
...
function customizeForm ()
{
    ...
    } ).on ( 'change', function ()
    {
        ...
        {
            case 'all':
                $ ( "#date_type, input[id*='DateY']" ).prop ( 'disabled', false ).trigger ( 'change' );
                zTree.checkNode ( nodes[0], false, true );
                break;

            case 'r1':
                $ ( "#date_type, input[id*='DateY']" ).prop ( 'disabled', true ).trigger ( 'change' );
...
function initTree ( data )
{
    ...
    var releaseType = $ ( "#preReleaseType" ).val ();
...
function searchAlarm ()
{
    $ ( '#btn_search' ).on (
            ...
            function ()
            {
                var href = contextPath + '/hom/operation/alarm/list.do';
                var fromDate = null;
                var toDate = null;
                ...
                location.href = href + '?eqmtId=' + Base64.URLEncode ( arrayId ) + '&searchDateType=' + dateType
                        + '&searchFromDate=' + pureFromDate + '&searchToDate=' + pureToDate + '&releaseType='
                        + releaseType;
            } );
}
