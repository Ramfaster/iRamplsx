...
function customizeJqgrid ()
{
    ...
    {
        colNames = [ i18nMessage.msg_authorityGroupId, i18nMessage.msg_authorityGroupKoreanName,
    ...
    {
        colNames = [ i18nMessage.msg_authorityGroupId, i18nMessage.msg_authorityGroupEnglishName,
                i18nMessage.msg_description ];
        colModel = [ {
            name : 'authGrpId',
            hidden : true
    ...
    $ ( '#gridList' ).jqGrid (
            {
                url : contextPath + '/hom/sysmgt/authority/list.ajax',
                mtype : 'POST',
                datatype : 'json',
                postData : {
                ...
                onSelectRow : function ( rowId, status )
                {
                    ...
                    location.href = contextPath + '/hom/sysmgt/authority/view.do?authGrpId=' + rowData.authGrpId
    ...
    $btnDelete.click ( function ()
    {
        ...
        } else
        {
            ...
            } ) ).then ( function ( confirm )
            {
                if ( confirm )
                {
                    location.href = $that.attr ( 'href' ) + '?authGrpId=' + acntIdArray.toString ();
                }
            } );
        }
