...
function customizeJqgrid ()
{
    ...
    {
        colNames = [ i18nMessage.msg_parameterId, i18nMessage.msg_parameterKoreanName, i18nMessage.msg_useAvailability,
    ...
    {
        colNames = [ i18nMessage.msg_parameterId, i18nMessage.msg_parameterEnglishName,
    ...
    $ ( '#gridList' ).jqGrid (
            {
                url : contextPath + '/hom/sysmgt/parameter/list.ajax',
                mtype : 'POST',
                datatype : 'json',
                postData : {
                ...
                onSelectRow : function ( rowId, status )
                {
                    ...
                    location.href = contextPath + '/hom/sysmgt/parameter/view.do?paramtrId=' + rowData.paramtrId
    ...
    $btnDelete.click ( function ()
    {
        ...
        } else
        {
            ...
            } ) ).then ( function ( confirm )
            {
                if ( confirm )
                {
                    location.href = $that.attr ( 'href' ) + '?paramtrId=' + acntIdArray.toString ();
                }
            } );
        }
