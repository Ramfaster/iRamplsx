...
function customizeTree ()
{
    ...
    $.ajax ( {
        url : contextPath + '/hom/asset/plantCostItem/selectItemInfoTreeList.ajax',
        type : 'POST',
        dataType : 'json',
        data : {
            method : paramMethod,
        ...
        success : function ( json )
        {
            if ( json.status === staticVariable.jsonStatusSuccess )
            {
                ...
                if ( checkedNodes.length > 0 )
                {
                    ...
                    paramPvId = checkedNodes[0].mdlPid;
                    paramParntsItemId = checkedNodes[0].pId;
                ...
                } else if ( checkedNodes.length === 0 )
                {
                    ...
                    paramItemId = node.id;
                    paramPvId = node.mdlPid;
                    paramParntsItemId = node.pId;
                }
