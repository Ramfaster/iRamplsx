...
function getEqmtTreeList ()
{
    ...
    $.ajax ( {
        ...
        success : function ( json )
        {
            ...
            {
                var id = paramEqmtId + '|' + paramAdiEqmtId;
                var node = _.find ( json.data, function ( node )
                {
                    return node.id === paramMdlEqmtId && node.pId === id;
                } );
...
function setListHref ()
{
    ...
    var href = $btnList.attr ( 'href' ) + '?eqmtId=' + paramEqmtId + '|' + paramAdiEqmtId + '&mdlEqmtId='
            + paramMdlEqmtId;
