    ...
    $ ( "#tabsRptList01" ).on (
            ...
            function ()
            {
                ...
                if ( paramRunOmRptAjax01 == false )
                {
                    ...
                    fnRptOmMonthlyPlantInit ( $ ( "#lisRptList01" ), fnCallBackHighchart, $ ( "#rptSeq" ).val (), $ (
    ...
    $ ( "#tabsRptList02" ).on (
            ...
            function ()
            {
                ...
                if ( paramRunOmRptAjax02 == false )
                {
                    ...
                    fnRptOmMonthlyPlantWarnLoad ( $ ( "#lisRptList02" ), fnCallBackHighchart, $ ( "#rptSeq" ).val (),
                            $ ( "#rptMbySectn" ).val (), $ ( "#rptMbyId" ).val (), $ ( "#rptTyCd" ).val (), $ (
                                    "#rptCycleCd" ).val (), $ ( "#stdrYm" ).val () );
                }
    ...
    $ ( "#tabsRptList03" ).on (
            ...
            function ()
            {
                ...
                if ( paramRunOmRptAjax03 == false )
                {
                    ...
                    fnRptOmMonthlyPlantTotalLoad ( $ ( "#lisRptList03" ), fnCallBackHighchart, $ ( "#rptSeq" ).val (),
                            $ ( "#rptMbySectn" ).val (), $ ( "#rptMbyId" ).val (), $ ( "#rptTyCd" ).val (), $ (
                                    "#rptCycleCd" ).val (), $ ( "#stdrYm" ).val () );
                }
            } );
