...
function customizeJqgrid ()
{
    ...
    var colNames = null;
    var colModel = null;
    colNames = [ i18nMessage.msg_tagName, i18nMessage.msg_alarmName, i18nMessage.msg_eqmtSection,
                        ...
                        loadComplete : function ( data )
                        {
                            ...
                            } else
                            {
                                ...
                                for ( var i = 0, length = ids.length; i <= length; i++ )
                                {
                                    ...
                                    } else if ( rowData.alarmGradCd == "ALVL02" )// Warning
                                    {
...
function searchJqgrid ()
{
    ...
    {
        reloadJqgrid ( $gridList, $searchKey, $searchValue, $selBox, $notice, $warning, $fault, $disconnect );
...
// jqgrid reload
function reloadJqgrid ( $gridList, $searchKey, $searchValue, $searchEqmtGrpCd, $notice, $warning, $fault, $disconnect )
{
