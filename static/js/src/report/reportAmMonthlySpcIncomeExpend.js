function fnRptAmSpcInExLoad ( divHtmlId, callbackfn, rptSeq, rptMbySectn, rptMbyId, rptTyCd, rptCycleCd, stdrYm )
{

    var tpl = getTemplate ( templates.reportAmMonthlySpcInEx );
    ...
    $.ajax ( {
        url : contextPath + '/hom/reportmgt/selectReportAmMonthlySpcIncomeExpend.ajax',
        type : 'GET',
        async : false,
        data : params,
        dataType : 'json',
        success : function ( json )
        {
            ...
            if ( json.status === staticVariable.jsonStatusSuccess )
            {
                if ( tpl !== null )
                {
                    ...
                    fnRptAmSpcInExHighcharts ( json.data );
                }
...
function fnRptAmSpcInExHighcharts ( data )
{
