function fnRptAmSpcCurrentPowerLoad ( divHtmlId, callbackfn, rptSeq, rptMbySectn, rptMbyId, rptTyCd, rptCycleCd, stdrYm )
{

    var tpl = getTemplate ( templates.reportAmMonthlySpcCur );
    ...
    $.ajax ( {
        url : contextPath + '/hom/reportmgt/selectReportAmMonthlySpcCurrentPower.ajax',
        type : 'GET',
        async : false,
        data : params,
        dataType : 'json',
        success : function ( json )
        {
            ...
            if ( json.status === staticVariable.jsonStatusSuccess )
            {
                if ( tpl !== null )
                {
                    ...
                    fnRptAmSpcCurrentPowerHighcharts ( json.data );
                }
...
function fnRptAmSpcCurrentPowerHighcharts ( data )
{
